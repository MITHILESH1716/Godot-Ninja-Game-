...
func _on_player_in_range_body_exited(_body: Node2D) -> void:
	stop_tracking()
...
func _on_animated_sprite_2d_animation_finished() -> void:
	if animated_sprite_2d.animation == "attack_1" or "attack_2" or "attack_3" or "attack_4":
		collision_shape_2d_attack.disabled = true
		if !dead: current_state = State.RUN
...
func _on_hurt_box_area_entered(area: Area2D) -> void:
	if area.is_in_group("Sword"):
		...
		if !dead:
			...
			_1_label.visible_characters = false
